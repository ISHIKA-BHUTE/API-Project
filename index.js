...
// if no specific book is return then the findone func returns null , and to execute the not
//found property we have to make the cond. inside if true !null is true.
if(!getSpecificBook) {
  return res.json({
